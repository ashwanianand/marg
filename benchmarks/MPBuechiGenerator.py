from grid.gridGenerator import random_grid_with_buechi_region_meanpayoff_region as MPBuechi
import argparse
import json
import os
import random
...
Example command:
python3 benchmarks/MPBuechiGenerator.py --num_benchmarks 500 --size 10-100 --wall_density 0.2 --region_ratio 0.01 --min_distance_ratio 0.1 --max_distance_ratio 0.2 --probabilistic_ratio 0.05 --output benchmarks/MPBuechi

python3 benchmarks/MPBuechiGenerator.py --num_benchmarks 500 --size 10-100 --wall_density 0.2 --region_ratio 0.01 --min_distance_ratio 0.7 --max_distance_ratio 0.9 --probabilistic_ratio 0.05 --output benchmarks/MPBuechi
